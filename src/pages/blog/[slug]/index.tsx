...
const BlogPost = ({ post, latestPosts, nextPost, prevPost }: Props): JSX.Element => {
  ...
  return (
    <Container>
      <Head>
        <title>{`${post.data.title[0].text} — ${APP_NAME}`}</title>
          ...
          <aside>
            <div className="p-4">
              ...
              <small className="hidden md:block">
                Feel free to keep browsing, here are some of my latest posts. You might find
